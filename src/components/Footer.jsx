...
export default function Footer() {
  ...
  return (
    <footer className="scroll-mt-24 bg-black text-gray-400 text-sm px-4 py-8 border-t border-gray-800">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <a
          href="https://wa.me/5547999999999" // troque pelo seu número real
          target="_blank"
          rel="noreferrer"
